...
export default function Sidebar() {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div
        className="flex items-center px-5 border-b border-zinc-100 shrink-0"
      ...
      <nav className="flex-1 px-2 py-3 flex flex-col gap-px overflow-y-auto">
        {NAV.map(({ href, label, icon, exact, indent }) => {
      ...
      <div className="px-2 pb-3 border-t border-zinc-100 pt-2">
        ...
        >
          <span className={cn("shrink-0", isActive("/settings") ? "text-brand-600" : "text-zinc-400")}>
            <SettingsIcon />
          </span>
          Settings
        </Link>
